...
**殘影鐵砧升級**：以四階殘影（黯淡／微茫／閃耀／輝煌 → 階級 1~4）在鐵砧升級同階飾品，等級 1→3 逐級提高效果倍率（1.25 / 1.50 / 2.00）。
...
遊戲內按住 **Shift** 可展開該飾品的完整機制說明，且**數值會反映目前的殘影升級等級**——升級前後直接比較即可。
